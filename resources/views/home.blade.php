...
<body class= " bg-color8">
    ...
    <section>
        ...
        <section class="flex justify-center ">
           <div class=" h-40 mt-4">
            <video width="320" style="height: 403px;" autoplay loop muted>
            ...
            <div class="flex flex-col text-center justify-center items-center">
                ...
                @endif
                <form name="form" action="{{ route('compra') }}" method="POST" id="miFormulario"
                    class="ml-10 w-80  mt-4 flex flex-col gap-4 max-w-sm py-8 px-3 bg-white ">
                    @csrf
                    <label class="text-green-400  font-bold">Productos</label>
                    <select required id="producto" name="productoi"
                    ...
                    <button type="submit" id="botonEnviar" class="bg-color2 py-1  rounded shadow">Finalizar
                        Compra</button>
                </form>
            </div>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    document.getElementById('miFormulario').addEventListener('submit', function(event) {
                        ...
                        if (productoSeleccionado === "") {
                            ...
                            event
                        .preventDefault(); // Evita que el formulario se envíe si no se ha seleccionado un producto.
                        } else if (productoSeleccionado === "selecciona_producto") {
                            alert('SELECIONE UN PRODUCTO');
                            event
                        .preventDefault(); // Evita que el formulario se envíe si se ha seleccionado la opción predeterminada.
                        } else {
                            alert('¡Muy bien!');
                    ...
                    function calcularTotal() {
                        ...
                        productosSeleccionados.forEach(function(producto) {
                            ...
                            var precio = parseFloat(producto.cantidad.nextElementSibling.textContent.replace(
                                'Precio: $', '')) || 0;
